function EPSC = solve_u_x (spikeMat,tmax,dt,A,U,tauD,tauF)

% The equations solved in this script were taken from the paper Differential signaling via the same axon of neocortical
% pyramidal neurons
