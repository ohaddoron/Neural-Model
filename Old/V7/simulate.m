...
Connectivity_Ratio = connect(params.num_of_presynaptic_neurons, params.num_of_postsynaptic_neurons, params.p);
...
if settings.one_on_one;
    ...
    tVec = (0:settings.dt:settings.tmax-settings.dt)*1e3/2;
    spikeMat(20*DT) = 1;
